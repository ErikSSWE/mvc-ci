...
class YatzyGame
{
    ...
    //måste kolla vilket nummer man är på
    //måste kolla hur mycket man fick när man känner sig klar
    //måste räka ut poängen för varje tal(alltså runda 1-6)
